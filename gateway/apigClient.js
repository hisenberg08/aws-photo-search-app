...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://d2olkf1jcl.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.photosItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'Content-Type', 'Accept'], ['body']);
        ...
        //console.log("request ", photosItemPutRequest);
